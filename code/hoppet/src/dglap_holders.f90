...
!!             call AddWithCoeff(dh%P_NLO%qq, CgPgq, zero)
!!             call AddWithCoeff(dh%P_NLO%qq, CqPqg, zero)
...
!!             call AddWithCoeff(dh%P_NLO%qg, CqPqg, zero)
!!             call AddWithCoeff(dh%P_NLO%qg, CgPgg, zero)
!!             call AddWithCoeff(dh%P_NLO%qg, CgPqq, zero)
!!             call AddWithCoeff(dh%P_NLO%qg, CgPqg, zero)
...
!!             call AddWithCoeff(dh%P_NLO%gq, CqPqq, zero)
!!             call AddWithCoeff(dh%P_NLO%gq, CgPgq, zero)
!!             call AddWithCoeff(dh%P_NLO%gq, CqPgq, zero)
!!             call AddWithCoeff(dh%P_NLO%gq, CqPgg, zero)
             !   Pgg -> Pgg + (-Cq Pqg - Cg Pgq)
             call AddWithCoeff(dh%P_NLO%gg, CqPqg,-one)
             call AddWithCoeff(dh%P_NLO%gg, CgPgq,-one)
!!             call AddWithCoeff(dh%P_NLO%gg, CqPqg, zero)
!!             call AddWithCoeff(dh%P_NLO%gg, CgPgq, zero)
             !
